<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('wings.create') }}" class="text-green-500 hover:text-green-700 mx-1"
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="overflow-x-auto">
                        ...
                        <div
                            ...
                            <a href="{{ route('wings.trash') }}" class="text-red-500 hover:text-red-700 mx-1"
        ...
        <script>
            document.addEventListener("DOMContentLoaded", () => {
                ...
                const fetchAnnouncements = async (search = '', page = 1) => {
                    try {
                        const response = await fetch(
                            `{{ route('wings.getData') }}?search=${search}&page=${page}`);
                ...
                document.getElementById("downloadPdfBtn").addEventListener("click", () => {
                    ...
                    let url = `{{ route('wings.download.pdf') }}`;
                    if (search) {
