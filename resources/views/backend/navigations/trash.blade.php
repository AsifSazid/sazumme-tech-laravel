                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="overflow-x-auto">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex justify-center space-x-2">
                                                <form action="{{ route('admin.navigations.restore', $trashed->uuid) }}"
                                                ...
                                                <form action="{{ route('admin.navigations.forceDelete', $trashed->uuid) }}"
                        ...
                        <div
                            ...
                            <a href="{{ route('admin.navigations.index') }}" class="text-blue-500 hover:text-blue-700 mx-1"
