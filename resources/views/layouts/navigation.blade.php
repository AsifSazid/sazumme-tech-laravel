    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @endif --}}
                @if (userHasRole('Super Admin'))
                    <div x-data="{ open: false }" class="relative hidden sm:ms-10 sm:flex">
                        <button @click="open = !open" @click.away="open = false"
                            class="inline-flex items-center px-3 py-2 text-sm font-medium leading-5 text-gray-700 transition duration-150 ease-in-out bg-white border border-transparent rounded-md hover:text-gray-800 focus:outline-none focus:text-gray-800">
                            Admin Panel
