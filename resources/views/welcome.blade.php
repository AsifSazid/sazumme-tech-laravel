...
<body>
    ...
    <div class="main-wrapper">
            ...
            <div class="container">
                ...
                <div class="header-wrap">
                    ...
                    <div class="header-logo">
                        <a href="index.html"><img src="{{asset('ui/frontend/assets')}}/images/logo.png" alt=""></a>
                    </div>
                                ...
                                <div class="cart-items">
                                    ...
                                    <div class="single-cart-item">
                                        <div class="item-image">
                                            <img src="{{asset('ui/frontend/assets')}}/images/shop-cart-1.jpg" alt="cart">
                                        </div>
                                    ...
                                    <div class="single-cart-item">
                                        <div class="item-image">
                                            <img src="{{asset('ui/frontend/assets')}}/images/shop-cart-2.jpg" alt="cart">
                                        </div>
                                        <div class="item-content">
                                    ...
                                    <div class="single-cart-item">
                                        <div class="item-image">
                                            <img src="{{asset('ui/frontend/assets')}}/images/shop-cart-3.jpg" alt="cart">
                                        </div>
                                        <div class="item-content">
        ...
        <!-- Hero Start -->
        <div class="section techwix-hero-section-03 d-flex align-items-center" style="background-image: url({{asset('ui/frontend/assets')}}/images/hero-bg3.jpg);">
            <div class="shape-1">
        ...
        <!-- Service Start -->
        <div class="section techwix-service-section-03" style="background-image: url({{asset('ui/frontend/assets')}}/images/bg/service-bg3.jpg);">
            <div class="container">
                <!-- Service Wrap Start -->
        ...
        <!-- Choose Us Start -->
        <div class="section techwix-choose-us-section section-padding" style="background-image: url({{asset('ui/frontend/assets')}}/images/bg/choose-us-bg.jpg);">
            <div class="container">
                    ...
                    <div class="choose-us-content-wrap">
                        <div class="row">
                            <div class="col-lg-4 col-md-6">
                                ...
                                <div class="choose-us-item">
                                    <div class="choose-us-img">
                                        <a href="choose-us.html"><img src="{{asset('ui/frontend/assets')}}/images/choose-us1.jpg" alt=""></a>
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <div class="choose-us-item">
                                    <div class="choose-us-img">
                                        <a href="choose-us.html"><img src="{{asset('ui/frontend/assets')}}/images/choose-us2.jpg" alt=""></a>
                                        <div class="choose-us-content">
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <div class="choose-us-item">
                                    <div class="choose-us-img">
                                        <a href="choose-us.html"><img src="{{asset('ui/frontend/assets')}}/images/choose-us3.jpg" alt=""></a>
                                        <div class="choose-us-content">
        ...
        <!-- Case Study Start -->
        <div class="section techwix-case-study-section-02 section-padding" style="background-image: url({{asset('ui/frontend/assets')}}/images/bg/case-study-bg.jpg);">
            <div class="container">
                ...
                <div class="swiper-container case-study-active">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            ...
                            <div class="single-case-study-02">
                                <div class="case-study-img">
                                    <a href="#"><img src="{{asset('ui/frontend/assets')}}/images/case-4.jpg" alt=""></a>
                                </div>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="single-case-study-02">
                                <div class="case-study-img">
                                    <a href="#"><img src="{{asset('ui/frontend/assets')}}/images/case-5.jpg" alt=""></a>
                                </div>
                                <div class="case-study-content">
                                    <p class="sub-title">Database Security</p>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="single-case-study-02">
                                <div class="case-study-img">
                                    <a href="#"><img src="{{asset('ui/frontend/assets')}}/images/case-6.jpg" alt=""></a>
                                </div>
                                <div class="case-study-content">
                                    <p class="sub-title">Database Security</p>
                        ...
                        <div class="swiper-container testimonial-02-active">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    ...
                                    <div class="single-testimonial-02">
                                        <div class="testimonial-thumb">
                                            <img src="{{asset('ui/frontend/assets')}}/images/testi-3.jpg" alt="">
                                        </div>
                                        <div class="testimonial-content">
                                            <img src="{{asset('ui/frontend/assets')}}/images/testi-icon.png" alt="">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="single-testimonial-02">
                                        <div class="testimonial-thumb">
                                            <img src="{{asset('ui/frontend/assets')}}/images/testi-4.jpg" alt="">
                                        </div>
                                        <div class="testimonial-content">
                                            <img src="{{asset('ui/frontend/assets')}}/images/testi-icon.png" alt="">
                                            <p>Accelerate innovation with world-class tech teams Beyond more stoic this along goodness hey this this wow manatee </p>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    ...
                                    <div class="single-team">
                                        <div class="team-img">
                                            <a href="team.html"><img src="{{asset('ui/frontend/assets')}}/images/team/team-1.jpg" alt=""></a>
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="single-team">
                                        <div class="team-img">
                                            <a href="team.html"><img src="{{asset('ui/frontend/assets')}}/images/team/team-2.jpg" alt=""></a>
                                        </div>
                                        <div class="team-content">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="single-team">
                                        <div class="team-img">
                                            <a href="team.html"><img src="{{asset('ui/frontend/assets')}}/images/team/team-3.jpg" alt=""></a>
                                        </div>
                                        <div class="team-content">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="single-team">
                                        <div class="team-img">
                                            <a href="team.html"><img src="{{asset('ui/frontend/assets')}}/images/team/team-4.jpg" alt=""></a>
                                        </div>
                                        <div class="team-content">
                ...
                <div class="techwix-blog-wrap">
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="single-blog">
                                <div class="blog-image">
                                    <a href="blog-details.html"><img src="{{asset('ui/frontend/assets')}}/images/blog/blog-1.jpg" alt=""></a>
                                    <div class="top-meta">
                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="single-blog">
                                <div class="blog-image">
                                    <a href="blog-details.html"><img src="{{asset('ui/frontend/assets')}}/images/blog/blog-2.jpg" alt=""></a>
                                    <div class="top-meta">
                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="single-blog">
                                <div class="blog-image">
                                    <a href="blog-details.html"><img src="{{asset('ui/frontend/assets')}}/images/blog/blog-3.jpg" alt=""></a>
                                    <div class="top-meta">
        ...
        <div class="section techwix-cta-section-02">
            <div class="container">
                <!-- Cta Wrap Start -->
                <div class="cta-wrap" style="background-image: url({{asset('ui/frontend/assets')}}/images/bg/cta-bg.jpg);">
                    <div class="row align-items-center">
        ...
        <div class="section footer-section footer-section-03" style="background-image: url({{asset('ui/frontend/assets')}}/images/bg/footer-bg.jpg);">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-sm-6">
                            ...
                            <div class="footer-widget-about">
                                <a class="footer-logo" href="index.html"><img src="{{asset('ui/frontend/assets')}}/images/logo-white.png" alt="Logo"></a>
                                <p>Accelerate innovation with world-class tech teams We’ll match you to an entire remote team of incredible freelance talent.</p>
